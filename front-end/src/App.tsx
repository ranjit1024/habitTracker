        ...
        viewport={{
          ...
          <div className="bg-[#f1f4f1] flex w-full flex-col rounded-xl">
            <div className="bg-[#f1f4f1] flex w-full flex-col rounded-xl">
              ...
              <div className="bg-white p-8 flex justify-center flex-col items-center m-1 rounded-xl ">
                <div className=" object-center h-70 bg-contain bg-center bg-no-repeat  bg-[url(https://img.freepik.com/premium-vector/vector-illustration-study-concept-market-expansion-financial-report-investment-data_675567-9237.jpg)]   flex items-center justify-center gap-6  py-[3%] px-5 mx-2 w-[100%]">
    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">H-Track</span>
            </a>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">H-Track™</a>. All Rights Reserved.</span>
    </div>
</footer>
